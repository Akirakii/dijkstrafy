    ...
    <>
      {graph.edges.length > 0 ? (
        ...
        <div className="empty-graph-message">
          ...
          {graph.nodes.length > 1 ? (<p>Click and drag one node to another to create a connection!</p>) : <p>Calculates the shortest path on any directed weighted graph! 😮🪄 <br /> Click on the board to create some nodes and try to connect them!</p>}
        </div>
      )}
    </>
  );
